...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:/Users/KIIT01/Desktop/Sign language detection/Sign-Language-To-Text-and-Speech-Conversion/cnn8grps_rad1_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("American Sign Language To Text Conversion")
        ...
        self.T.config(text="American Sign Language To Text Conversion", font=("Courier", 30, "bold"))
