...
directory = "C:\\test_data_2.0\\Gray_imgs\\A"
if not os.path.exists(directory):
    os.makedirs(directory)
count = len(os.listdir(directory))

#testing data
count = len(os.listdir("C://test_data_2.0//Gray_imgs//A"))
...
while True:
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            count = len(os.listdir("C://test_data_2.0/Gray_imgs//" + p_dir + "//"))
        ...
        if flag==True:
            ...
            if step%2==0:
                ...
                cv2.imwrite("C:\\test_data_2.0\\Gray_imgs\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                            img_final1)
                cv2.imwrite(
                    "C:\\test_data_2.0\\Gray_imgs_with_drawing\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                    img_final2)
